package com.avinmlkit.textrecognition.textdetector;
...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, com.avinmlkit.textrecognition.textdetector.FrameMetadata metadata) {
    data.rewind();
